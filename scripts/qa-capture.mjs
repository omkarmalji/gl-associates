...
for (const [name, hash, wait = 900] of [
  ["desktop-brick", "#/?scene=6", 1200],
  ["desktop-typology", "#/?scene=9", 1200],
...
const result = { report, errors, geometryFailures, interactionFailures, visibilityFailures };
console.log(JSON.stringify(result, null, 2));
if (errors.length || geometryFailures.length || interactionFailures.length || visibilityFailures.length) process.exitCode = 1;
